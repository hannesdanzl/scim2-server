...
class InMemoryBackend(Backend):
    ...
    def create_resource(
        ...
        self._touch_resource(tenant_id, resource, utcnow)
    ...
    @staticmethod
    def _touch_resource(tenant_id: str, resource: Resource, last_modified: datetime.datetime):
    ...
    def update_resource(
        ...
        if found_res_idx is not None:
            ...
            self._touch_resource(tenant_id,
